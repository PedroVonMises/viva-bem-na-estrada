    ...
    <Layout>
      ...
      <article className="container py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg prose-invert prose-headings:font-bold prose-headings:text-white prose-p:text-slate-300 prose-p:mb-8 prose-p:leading-relaxed prose-strong:text-white prose-li:text-slate-300 max-w-none">
